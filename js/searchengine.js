...
displayCompanyTab.addEventListener("click", function() {
    ...
    // Apply subtle style to unselected creators tab
    creatorsTab.style.backgroundColor = "#007bff"; // Dark blue for unselected tab
    creatorsTab.style.color = "white";  // White text for unselected tab
    creatorsTab.style.boxShadow = "none"; // No shadow for unselected tab

    // Apply styles for the selected company tab
    companyTab.style.backgroundColor = "";  // Slightly darker blue for selected tab
    companyTab.style.color = "white";  // White text for selected tab
    companyTab.style.borderLeft = "2px solid #1e3d58"; // Dark left border for selected tab
    companyTab.style.borderTopLeftRadius = "9px"; // Rounded top-left corner for selected tab
    companyTab.style.borderBottom = "2px solid black"; // Bottom border for selected tab
    companyTab.style.boxShadow = "inset 0 2px 5px rgba(0, 0, 0, 0.1)"; // Add subtle inset shadow for the selected tab
    console.log("beep");
...
displayCreatorTab.addEventListener("click", function() {
    ...
    // Apply subtle style to unselected company tab
    companyTab.style.backgroundColor = "#007bff";  // Dark blue for unselected tab
    companyTab.style.color = "white";  // White text for unselected tab
    companyTab.style.boxShadow = "none"; // No shadow for unselected tab

    // Apply styles for the selected creator tab
    creatorsTab.style.backgroundColor = "";  // Slightly darker blue for selected tab
    creatorsTab.style.color = "white";  // White text for selected tab
    creatorsTab.style.borderRight = "2px solid #1e3d58"; // Dark right border for selected tab
    creatorsTab.style.borderBottom = "2px solid white"; // Bottom border for selected tab
    creatorsTab.style.boxShadow = "inset 0 2px 5px rgba(0, 0, 0, 0.1)";  // Add subtle inset shadow for the selected tab
    console.log("boop");
...
async function generateCards() {
    ...
    if (searchTab === "creator") {
        ...
        allResults.forEach(data => {
            ...
            titleCard.setAttribute('id', data.uid);

            titleCard.innerHTML = `
                <div class="cardSection" id="name">${data.firstName} ${data.lastName}</div>
                ...
                <div class="cardSection" id="bottomRight"><a href="${data.link}">${data.link}</a></div>
            `;
        ...
        allResults.forEach(data => {
            const titleCard = document.createElement('div');
            titleCard.setAttribute('class', 'titlecard');
            titleCard.setAttribute('id', data.uid); // Ensure unique ID for each card
    ...
    // Attach click listeners to all generated cards
    const titlecards = document.getElementsByClassName("titlecard");
    Array.from(titlecards).forEach((titlecard) => {
        titlecard.addEventListener("click", function() {
            // Use the ID to navigate to the profile page
            const profileId = this.id;
            if (profileId) {
                window.location.href = `../html/profilev2.html?userId=${profileId}`;
            } else {
                console.error("No ID found for the clicked titlecard element.");
            }
        });
    });
}
